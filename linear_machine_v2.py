...
try:
    ...
    p1 = pixel_to_world_using_camera_plane(FRAME_W / 2, FRAME_H / 2, K, dist, R, t, n_c, d_c)
    p2 = pixel_to_world_using_camera_plane(FRAME_W / 2 + 1, FRAME_H / 2, K, dist, R, t, n_c, d_c)
